// Netlify Serverless Function for tag generation
exports.handler = async (event, context) => {
  ...
  try {
    ...
    const { description, category, style, maxTags = 50, maxWordsPerTag = 3 } = body;
    ...
    // Limit to the requested number of tags
    ...
    return {
      statusCode: 500,
      body: JSON.stringify({ message: "Failed to generate tags", error: error.message }),
    };
  }
};
